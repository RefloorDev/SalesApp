...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CHRTextFieldFormatter/CHRTextFieldFormatter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JWTCodable/JWTCodable.framework"
