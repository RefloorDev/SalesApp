...
struct AppURL 
{
    ...
    //let LIVE_BASE_URL = "https://refloordev.oneteamus.com/api/" //Dev
...
//http://server.oneteamus.com:2446
    ...
    let TRAINING_BASE_URL = "https://odootraining.myx.ac/api/"
...
enum AppointmentLogMessages: String{
    ...
    case geoLocationEntryRegion = "Appointmnet entry region...."
    case geoLocationExitRegion = "Appointment exit region....."
