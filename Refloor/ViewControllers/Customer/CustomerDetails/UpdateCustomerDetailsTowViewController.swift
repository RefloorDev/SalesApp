//
//  UpdateCustomerDetailsTowViewController.swift
//  Refloor
//
...
class UpdateCustomerDetailsTowViewController:  UIViewController,UITextFieldDelegate {
    ...
    static func initialization() -> UpdateCustomerDetailsTowViewController? {
        return UIStoryboard(name:"Main", bundle: nil).instantiateViewController(withIdentifier: "UpdateCustomerDetailsTowViewController") as? UpdateCustomerDetailsTowViewController
    }
    ...
    override func viewDidAppear(_ animated: Bool)
    {
        logScreenEvent(screen: ScreenNames.updateCustomer2) {
            ...
            speedTest.testUploadSpeed { speed in
                ...
                let parameters:[String:Any] = ["appointment_id": AppointmentData().appointment_id ?? 0,"screen_name":ScreenNames.updateCustomer2,"screen_entry_date":Date().getSyncDateAsString(),"network_strength":networkMessage,"timezone":timeZone,"create_date": Date().getSyncDateAsString()]
   ...
   func update() {
    ...
    @IBAction func submitAndTransforButtonAction(sender: UIButton)
    {
        ...
        [
            ...
            "co_applicant_skipped":appoinmentslData       .co_applicant_skipped ?? 0,"isBothParties":appoinmentslData.isBothParties ?? 0]
      ...
      //  }
        ...
        let classDisplayName = "Update Customer2"
...
extension UpdateCustomerDetailsTowViewController: GMSAutocompleteViewControllerDelegate
{
...
extension UpdateCustomerDetailsTowViewController: ImagePickerDelegate {
