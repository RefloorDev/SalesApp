//
//  UpdateCustomerDetailsOneViewController.swift
//  Refloor
//
...
class UpdateCustomerDetailsOneViewController:  UIViewController,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate, DropDownDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.setNavigationBarbackAndlogo(with: "Update Customer 1 Details")
    ...
    override func viewDidAppear(_ animated: Bool)
    {
        logScreenEvent(screen: ScreenNames.updateCustomer1) {
            ...
            speedTest.testUploadSpeed { speed in
                ...
                let parameters:[String:Any] = ["appointment_id": AppointmentData().appointment_id ?? 0,"screen_name":ScreenNames.updateCustomer1,"screen_entry_date":Date().getSyncDateAsString(),"network_strength":networkMessage,"timezone":timeZone,"create_date": Date().getSyncDateAsString()]
...
//    }
    @IBAction func submitAndTransforButtonAction(_ sender: Any) {
        ...
        let classDisplayName = "Update Customer1"
...
extension UpdateCustomerDetailsOneViewController: GMSAutocompleteViewControllerDelegate
{
...
extension UpdateCustomerDetailsOneViewController: ImagePickerDelegate {
