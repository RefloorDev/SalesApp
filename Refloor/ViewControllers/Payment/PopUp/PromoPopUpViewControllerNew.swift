...
class PromoPopUpViewControllerNew: UIViewController {
    ...
    @IBAction func resetAction(_ sender: UIButton) {
        ...
        self.discountDelegate?.discountApplied(discountAmount: 0.0, discountArray: self.discountArray)
    }
    ...
    @IBAction func doneAction(_ sender: UIButton) {
        ...
        print(totalDiscount)
       // if totalDiscount > 0{
            self.discountDelegate?.discountApplied(discountAmount: totalDiscount, discountArray: self.discountArray)
       // }
        self.dismiss(animated: true)
    }
