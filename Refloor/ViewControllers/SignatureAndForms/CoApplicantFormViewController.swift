...
import GoogleMaps
import GooglePlaces
class CoApplicantFormViewController: UIViewController,DropDownDelegate,UITextFieldDelegate
{
    static public func initialization() -> CoApplicantFormViewController? {
        return UIStoryboard(name:"Main", bundle: nil).instantiateViewController(withIdentifier: "CoApplicantFormViewController") as? CoApplicantFormViewController
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.deleteCoApplicantDataFromAppointmentDetail()
    }
...
extension CoApplicantFormViewController: GMSAutocompleteViewControllerDelegate
{
...
enum HispanicStatusCoApplication
{
    case Hispanic
    case NotHispanic
    case DoNotShare
