...
class PaymentDetailsViewController: UIViewController, versatileProtocol{
    ...
    override func viewDidAppear(_ animated: Bool)
    {
        ...
        logScreenEvent(screen: ScreenNames.paymentSummary) {
            var networkMessage = ""
            ...
            speedTest.testUploadSpeed { speed in
                ...
                let parameters:[String:Any] = ["appointment_id": AppointmentData().appointment_id ?? 0,"screen_name":ScreenNames.paymentSummary,"screen_entry_date":Date().getSyncDateAsString(),"network_strength":networkMessage,"timezone":timeZone,"CreatedDate": Date().getSyncDateAsString()]
...
//                }
            ...
            else
            {
                ...
                details.excluded_amount_promotion = excluded_amount_promotion
